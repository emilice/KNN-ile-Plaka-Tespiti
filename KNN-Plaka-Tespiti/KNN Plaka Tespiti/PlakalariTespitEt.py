...
def plaka_tespit_et(imgOriginalScene):
    ...
    imgGrayscaleScene, imgThreshScene = on_hazirlik.onhazirlikislemi(imgOriginalScene)         # preprocess to get grayscale and threshold images
...
def findPossibleCharsInScene(imgThresh):
    ...
    for i in range(0, len(contours)):                       # for each contour
        ...
        if KarakterTespitEt.checkIfPossibleChar(possibleChar):                   # if contour is a possible char, note this does not compare to other chars (yet) . . .
