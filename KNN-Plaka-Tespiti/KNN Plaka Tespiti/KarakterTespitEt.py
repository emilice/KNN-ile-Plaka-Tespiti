...
def plakada_karakter_tespit_et(listOfPossiblePlates):
    ...
    for possiblePlate in listOfPossiblePlates:          # for each possible plate, this is a big for loop that takes up most of the function
        ...
        possiblePlate.imgGrayscale, possiblePlate.imgThresh = on_hazirlik.onhazirlikislemi(possiblePlate.imgPlate)     # preprocess to get grayscale and threshold images
...
def recognizeCharsInPlate(imgThresh, listOfMatchingChars):
    ...
    for currentChar in listOfMatchingChars:                                         # for each char in plate
        ...
        cv2.rectangle(imgThreshColor, pt1, pt2, Main.yesil, 2)           # draw green box around the char
